...
import { FiHome, FiUser, FiCpu, FiFolder, FiMail } from 'react-icons/fi'
...
const Sidebar = () => {
  ...
  return (
    <aside className="fixed left-0 top-0 z-50 h-screen w-20 flex flex-col items-center justify-between py-8 bg-[#1a1a2e]/80 backdrop-blur-xl border-r border-white/5">
      {/* Logo / Brand Icon */}
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {/* Tooltip */}
              <span className="absolute left-14 px-3 py-1.5 bg-[#1a1a2e] text-white text-xs font-medium rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none whitespace-nowrap border border-white/10 shadow-xl shadow-purple-500/10 translate-x-2 group-hover:translate-x-0">
                {item.name}
              </span>
            </Link>
          )
